...
func TestSelect(t *testing.T) {
	...
	// if err != nil || sql != answer {
	// 	if err != nil {
	// 		t.Errorf(fmt.Sprintf("TestSelect | Error: %+v\n", err))
	// 	}

	// 	if sql != answer {
	// 		t.Errorf(fmt.Sprintf("TestSelect |\nanswer: %s\nsql: %s", answer, sql))
	// 	}
	// }
}
...
func TestUpdate(t *testing.T) {
	...
	// if err != nil || sql != answer {
	// 	if err != nil {
	// 		t.Errorf(fmt.Sprintf("TestUpdate | Error: %+v\n", err))
	// 	}

	// 	if sql != answer {
	// 		t.Errorf(fmt.Sprintf("TestUpdate |\nanswer: %s\nsql: %s", answer, sql))
	// 	}
	// }
}
...
func TestDelete(t *testing.T) {
	...
	// if err != nil || sql != answer {
	// 	if err != nil {
	// 		t.Errorf(fmt.Sprintf("TestDelete | Error: %+v\n", err))
	// 	}

	// 	if sql != answer {
	// 		t.Errorf(fmt.Sprintf("TestDelete |\nanswer: %s\nsql: %s", answer, sql))
	// 	}
	// }
}
